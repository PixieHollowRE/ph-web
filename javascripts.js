...
function gotoAccountManager(){
	window.location = "http://disney.go.com/fairies/pixiehollow/accountmanagement_pv.html"

}
function turnonEMS(xtext){
	var varEMS = document.getElementById("emsg")
	varEMS.style.visibility = "visible"
	varEMS.style.display = "block"
	varEMS.className = "DisplayBlock"
	document.getElementById("EMSText").innerHTML = "<div class=\"emsg_inner\"><span>"+xtext+"</span></div></div>";
}
