...
(function (a) {
  a.cookie = function (a) {
      ...
      if (document.cookie) {
        ...
        for (var k = 0; k < j.length; k++) {
          ...
          if (l.substring(0, a.length + 1) == a + "=")
            return decodeURIComponent(l.substring(a.length + 1));
        }
      }
      return null;
    }
    ...
    if (c.expires && typeof c.expires == "number") {
      var i = new Date();
      (i.setTime(i.getTime() + c.expires * 864e5),
  ...
  ((a.flashProxy = function (b, c, d, e, f) {
    ...
    (a.flashProxy.init = function () {
      ((a.flashProxy.count = 1),
        (a.flashProxy.ready = !0),
        (a.flashProxy.fn_success = []),
        (a.flashProxy.fn_fail = []));
    }));
})(jQuery);
...
(function (a) {
  a.fn.replaceTitle = function (b) {
    (a.fn.replaceTitle.count || (a.fn.replaceTitle.count = 1),
      a(this).each(function () {
        ...
        if (a(this).css("color").substr(0, 1) == "#")
          e = "0x" + a(this).css("color").substr(1);
        else {
          var f = a(this)
            .css("color")
            .match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/);
          delete f[0];
          for (var g = 1; g <= 3; ++g)
            ((f[g] = parseInt(f[g]).toString(16)),
              f[g].length == 1 && (f[g] = "0" + f[g]));
          e = "0x" + f.join("");
        }
        (swfobject.embedSWF(
          b.font,
...
(function (a) {
  ...
  ((a.formError = {}),
    ...
    (a.formError.updatePositions = function (a) {
      function b(a) {
        var b, c, d, g, h, i;
        ((c = e.displayUnderElement[a]),
          (d = c.element),
          (g = d.offset()),
          (h = c.offsetParent.offset()),
          c.errorElement.css({
      ...
      if (a !== undefined) b(a);
        ...
        for (i in e.displayUnderElement)
          e.displayUnderElement.hasOwnProperty(i) && b(i);
    }),
    ...
    (a.formError.displayUnderElement = function (b, c) {
      var f = h(),
        g = d + f,
        i = b.offsetParent();
      (i.append(j(g, c, "position : absolute;")),
        (e.displayUnderElement[f] = {
          offsetParent: i,
          element: b,
          errorElement: a("#" + g),
        }),
...
var swfobject = (function () {
  ...
  function T(c, d, e, f) {
    if (!y.ie || !y.mac) {
      ...
      y.ie && y.win
        ? v && typeof v.addRule == b && v.addRule(c, d)
        : v &&
  ...
  function L(c, d, f) {
    ...
    if (h) {
      ...
      if (y.ie && y.win) {
        var i = "";
        for (var j in c)
          c[j] != Object.prototype[j] &&
            (j.toLowerCase() == "data"
              ? (d.movie = c[j])
              : j.toLowerCase() == "styleclass"
                ? (i += ' class="' + c[j] + '"')
                : j.toLowerCase() != "classid" &&
                  (i += " " + j + '="' + c[j] + '"'));
        var k = "";
        for (var l in d)
          d[l] != Object.prototype[l] &&
        ...
        for (var o in c)
          c[o] != Object.prototype[o] &&
            (o.toLowerCase() == "styleclass"
              ? m.setAttribute("class", c[o])
              : o.toLowerCase() != "classid" && m.setAttribute(o, c[o]));
        for (var p in d)
          d[p] != Object.prototype[p] &&
            p.toLowerCase() != "movie" &&
            M(m, p, d[p]);
    ...
    if (y.win && y.ie) c.innerHTML = a.innerHTML;
      ...
      if (d) {
        ...
        if (e) {
          var f = e.length;
          for (var g = 0; g < f; g++)
            (e[g].nodeType != 1 || e[g].nodeName != "PARAM") &&
              e[g].nodeType != 8 &&
  ...
  function I(b, c, d, e) {
    ...
    if (g) {
      ...
      if (
        typeof b.width == a ||
        (!/%$/.test(b.width) && parseInt(b.width, 10) < 310)
      )
        b.width = "310";
      if (
        typeof b.height == a ||
        (!/%$/.test(b.height) && parseInt(b.height, 10) < 137)
      )
        b.height = "137";
          ...
          if (g)
            if (S(m[c].swfVersion) && !(y.wk && y.wk < 312))
              ...
              var i = {},
                ...
                k = j.length;
              for (var l = 0; l < k; l++)
                j[l].getAttribute("name").toLowerCase() != "movie" &&
  ...
  var a = "undefined",
    ...
    z = (function () {
      !y.w3 ||
        (((typeof i.readyState != a && i.readyState == "complete") ||
          ...
          y.ie &&
            ...
            (i.attachEvent(g, function () {
              i.readyState == "complete" &&
                (i.detachEvent(g, arguments.callee), A());
            }),
            h == top &&
              (function () {
                if (!t) {
    ...
    expressInstallCallback: function () {
      if (u) {
        ...
        (a &&
          ...
          q && (U(q, !0), y.ie && y.win && (p.style.display = "block")),
          r && r(s)),
          (u = !1));
      }
    },
...
var Fairies = function (g) {
  ...
  var c =
    ...
    PATH.CDN +
    '/pixie-hollow/img/misc/globe.png" width="37" height="36" alt="Globe"/>';
  var a =
  ...
  this.getNavigationSection = function () {
    ...
    if (!location.href.match(o) && location.href.match(l)) {
      o =
        ...
        "/" +
        location.href.slice(
          location.href.indexOf(l) + l.length + 1,
    ...
    if (
      ...
      location.href.indexOf("nevernews") >= 0 ||
      location.href.indexOf("winners") >= 0
    ) {
      m =
        m +
        "/" +
        location.href.slice(
          location.href.indexOf(n) + n.length + k.length,
          location.href.length - 1,
        );
    } else {
      if (location.href.indexOf("/pixie-central/") >= 0) {
        m =
          ...
          "/" +
          location.href.slice(
            location.href.indexOf(m) + m.length + 1,
            location.href.length - 1,
          );
      }
    }
    return location.href.indexOf("/pixie-central/") >= 0 ||
      location.href.indexOf("events") >= 0 ||
      location.href.indexOf("nevernews") >= 0 ||
      location.href.indexOf("winners") >= 0
      ? m
  ...
  this.updateLegalFooter = function () {
    if (
      ...
      location.href.indexOf("/pixie-pages/") >= 0 ||
      $("#footer").offset() == null
    ) {
      $("#footer .legal").show();
      return;
  ...
  this.trackBIPageLoad = function () {
    j.API.listen("whoAmI", function () {
      ...
      var t = PROTOCOL + "://weblogger-dynamic-lb.playdom.com/flash_log?",
        ...
        s =
          "app=" +
          (PATH.root == "http://" + r + k + ".go.com/fairies"
            ? "pixie_hollow"
            : "qa_pixie_hollow"),
        o = "&tag=clicked_link",
        ...
        y =
          "&tracking_code=" +
          (j.getQueryString("source") == undefined
            ? ""
            : j.getQueryString("source")),
        u = "&is_new_user=0",
...
var API = function (h) {
  ...
  var s = {
    ...
    calls: {
      ...
      accountManager:
        PATH.SSLRoot + "/pixie-hollow/membership/account-manager.html",
      ...
      cardExpiration:
        PATH.root + "/pixie-hollow/membership/card-expiration.html",
  ...
  function j(v, w) {
    ...
    switch (v) {
      case "whoAmI":
        if (
          m.isLoggedIn() &&
          $.inArray(location.href, [
            s.calls.contactCs,
            s.calls.dName,
            s.calls.cardExpiration,
            s.calls.TOS,
          ]) === -1
        ) {
        ...
        if (t == false) {
          ...
          if (m.isLoggedIn()) {
            ...
            c.loggedIn = true;
            $(s.selectors.memberInfo).html(
              '<a href="#" class="user-name">' +
                m.getDisplayName() +
                '</a> | <a href="#" class="logout">Log Out</a> | <a href="#" class="account-manager">Account Manager</a>',
            );
          } else {
            $(s.selectors.memberInfo).html(
              '<a href="#" class="login">Log In</a> | Create a Fairy and Fly',
            );
          }
        }
        break;
  ...
  function a() {
    ...
    $("#gde_footerContainer a, #header .pixie-hollow-logo a").live(
      "click",
      function (w) {
  ...
  function q() {
    if (
      ...
      location.href.indexOf("/pixie-central/") < 0 &&
      location.href.indexOf("blog.pixiehollow") < 0
    ) {
      return;
    }
    if (g !== undefined) {
  ...
  this.loadLookupAccount = function () {
    ...
    m.listen("whoAmI", function () {
      if (m.getUserID() > 0) {
        $.flashProxy.get(
          s.calls.lookupAccount + "?userId=" + m.getUserID(),
          function (v) {
  ...
  this.isLoggedIn = function () {
    return (
      $("status", m.XMLs.whoAmI).text() == "logged_in" ||
      $("status", m.XMLs.whoAmI).text() == "logged_in_fairy"
    );
  };
  ...
  this.getDaysTillExpire = function (v) {
    m.listen("whoAmI", function () {
      if (
        ($("order_type", m.XMLs.whoAmI).text() == "Prepaid" ||
          $("order_type", m.XMLs.whoAmI).text() == "PP") &&
        $("sub_exp_date", m.XMLs.whoAmI).text()
      ) {
  ...
  this.getServerTime = function (v) {
    m.listen("whoAmI", function () {
      var w = $("server-time day", m.XMLs.whoAmI)
        .text()
        .split("/")
        .concat($("server-time time", m.XMLs.whoAmI).text().split(":"));
  ...
  this.getPixieStandardTime = function (v) {
    m.listen("whoAmI", function () {
      ...
      var w = x.split(":");
      v(
        (parseInt(w[0]) > 12 ? parseInt(w[0]) - 12 : parseInt(w[0])) +
          ":" +
          w[1] +
          (parseInt(w[0]) > 12 ? "pm" : "am"),
      );
    });
  };
  ...
  this.getNotice = function (z) {
    ...
    switch (z) {
      ...
      case "dName":
        return (
          $("dname", m.XMLs.whoAmI).text() === "" ||
          $("notify_reject", m.XMLs.whoAmI).length > 0
        );
        break;
      case "gameCard":
...
var MiniManager = function (a) {
  function o() {
    ("object" == typeof a && (e = $.extend(e, a)),
      $(e.selectors.login).click(v),
      $(e.selectors.loginForm)
        .find("input")
        .keydown(function (a) {
          13 == a.which && v(a);
        }),
      $(e.selectors.selectFairy).live("click", w),
      $(e.selectors.playFairy).live("click", function () {
        fairies.trackPage(
          "minimanager_playnow",
          "pixiehollow:website:minimanager",
        );
      }),
      $(e.selectors.playFairy).live("click", x),
      $(e.selectors.pixiePage).live("click", function () {
        fairies.trackPage(
          "minimanager_pixiepage",
          "pixiehollow:website:minimanager",
        );
      }),
      $(e.selectors.pixiePage).live("click", y),
      $("#sign-up-button").live("click", function () {
        fairies.trackPage(
          "minimanager_signup",
          "pixiehollow:website:minimanager",
        );
      ...
      $("#become-member-button").live("click", function () {
        fairies.trackPage(
          "minimanager_becomemember",
          "pixiehollow:website:minimanager",
        );
      }),
      $(e.selectors.createFairy).live("click", z),
      $(e.selectors.deleteFairy).live("click", A),
      $(e.selectors.loginForm).submit(v),
      setTimeout(function () {
        swfobject.embedSWF(
          e.calls.loaderSWF,
          e.selectors.loader,
      ...
      fairies.isInIFrame() &&
        "PpPHPixMnc00003" == $.cookie("SOURCE") &&
        (e.calls.signup =
          PATH.root + "/pixie-hollow/miniclip/registration.html"),
      fairies.API.listen("whoAmI", C),
      (e.calls.purchase = t(e.calls.purchase)));
    var g =
      (-1 != location.href.search("pixie-hollow-world") ? !0 : !1,
      -1 != location.href.search("pixie-central") ? !0 : !1,
      -1 != location.href.search("pixie-hollow") ? !0 : !1,
      -1 != location.href.search("pixiehollow") ? !0 : !1,
  ...
  function s() {
    ...
    return (
      (isCreateAFairy = a.search("pixie-hollow/create")),
      (isGame = a.search("pixie-hollow/game")),
  ...
  function u(a) {
    ((g = a),
      g
        ? ($(e.selectors.loaderContainer).show(),
          $(e.selectors.login).addClass("button-disabled"),
          $(e.selectors.login).data(
            "text",
            $(e.selectors.login + " span").html(),
          ),
          $(e.selectors.login + " span").html("Loading"))
        : ($(e.selectors.loaderContainer).hide(),
          $(e.selectors.login).removeClass("button-disabled"),
          $(e.selectors.login + " span").html(
  ...
  function v(a) {
    ...
    if ((a.preventDefault(), !g)) {
      if (
        ...
        $(e.selectors.loginForm).find("input[name=password]").val() ||
          b.push({
        ...
        $.flashProxy(
          ...
          { type: "post" },
          {
            username: $(e.selectors.loginForm)
              ...
              .val(),
            password: $(e.selectors.loginForm)
  ...
  function w() {
    ($(this).parent().find(".selected-fairy").removeClass("selected-fairy"),
      ...
      (h = $(this).attr("rel")),
      "create" == h
        ? ($(e.selectors.playFairy).hide(),
          $(e.selectors.pixiePage).hide(),
          $(e.selectors.createFairy).css("display", "inline-block"))
        : h &&
          ($(e.selectors.playFairy).css("display", "inline-block"),
      ...
      ((a = $.parseXML(a)),
        "true" != $("success", a).text() ||
          ((top.location.href =
            e.calls.pixiePage +
            "#/" +
            $("fairy[fairy_id=" + h + "] address", b).text()),
      ...
      ? (head.js(
          ...
          function () {
            var a = $(e.selectors.content + " .selected-fairy p").text(),
              b =
                "<p>Careful! This will delete " +
                a +
                " forever. To delete this Fairy, enter your password.</p>";
            ((b += '<p class="delete-fairy-errors"></p>'),
              (b += "<h5>Password</h5>"),
              (b +=
                '<p><input type="password" class="text-input delete-fairy-password" /></p>'),
              (b +=
                '<p class="center"><a href="#" class="button-blue delete-fairy-continue"><span>Continue</span></a> &nbsp; <a href="#" class="button-orange delete-fairy-cancel"><span>Cancel</span></a></p>'));
            var c = new MiniPopup({
              title: "Delete Fairy?",
              content: b,
            ...
            ($(".delete-fairy-cancel").click(c.close),
              $(".delete-fairy-continue").click(function (a) {
                ($(".delete-fairy-continue").addClass("button-disabled"),
                  a.preventDefault(),
                  $.flashProxy.post(
                    e.calls.deleteFairy,
                    {
                    ...
                    function (a) {
                      if (
                        ((a = $.parseXML(a)),
                        $(".delete-fairy-continue").removeClass(
                          "button-disabled",
                        ),
                        "true" != $("success", a).text())
                      ) {
                        var b = $("error", a).attr("code"),
                          d = {
                            defaultMessage:
                              "Sorry, something's not right. Try back later!",
                            NOT_FAIRY_OWNER:
                              "Sorry, something's not right. Try back later!",
                            FAIRY_IN_USE:
                              "Sorry, something's not right. Try back later!",
                        ...
                        ($.formError.clear(),
                          $.formError.displayUnderElement(
                            $(".delete-fairy-password"),
                            void 0 !== d[b] ? d[b] : d.defaultMessage,
                          ));
        ...
        ? ((b = $("error", a).attr("code")),
          "function" == typeof c[b]
            ...
            : $.formError.displayInsideElement(
                $(e.selectors.loginForm),
                void 0 !== c[b] ? c[b] : c.defaultMessage,
              ))
        : ($(e.selectors.loginForm).find("input").val(""),
          $("access", fairies.API.XMLs.whoAmI).text($("access", a).text()),
          fairies.API.listen("whoAmI", function () {
            var b = $("dname_approved", a).text(),
              c = $("dname_submitted", a).text();
            ("true" != b && "true" != c && "true" != $.cookie("justRegistered")
              ? (top.location.href = e.calls.dnamePage)
              : "/fairies/AB/index.html" == location.pathname ||
                "/fairies/AB/" == location.pathname,
              "function" == typeof userLoggedIn && userLoggedIn(),
              "function" == typeof i
                ? (fairies.API.listen("fairies", function () {
                    i();
                  }),
                  fairies.API.loadFairies())
                : f.showPickAFairy());
          }),
  ...
  function F() {
    ...
    if ("true" == $("success", a).text()) {
      ...
      if (
        ...
        d &&
          $("fairies fairy", a).length <= 1 &&
          (!g || (g && !fairies.API.isPaid())))
      )
        return (G(a), void 0);
      $("fairies fairy", a).each(function () {
        ++f > 3 ||
          ((c += '<div class="fairy" rel="' + $(this).attr("fairy_id") + '">'),
          d || (c += '<a class="delete-fairy"><span>Delete</span></a>'),
          (c +=
            '<div class="fairy-bust"><img src="' +
            e.calls.renderer +
            $(this).attr("fairy_id") +
            '/" /></div>'),
          (c += "<p>" + $(this).find("name").text() + "</p>"),
          (c += "</div>"));
      });
      for (
        var h = $("fairies fairy", a).length;
        3 > h && !(d && !fairies.API.isPaid() && h >= 1);
        h++
      )
        ((c += '<div class="fairy" rel="create">'),
          (c +=
            '<div class="fairy-default"><img src="' +
            PATH.CDN +
            '/pixie-hollow/img/content/mini-manager/icon.fairy.png" /></div>'),
          (c += "<p>Create a Fairy</p>"),
          (c += "</div>"));
      ((c +=
        '<p class="center buttons"><a href="#" class="button-blue button-pixie-page"><span>Pixie Page</span></a> &nbsp; <a href="#" class="button-orange button-game"><span>Play</span></a> &nbsp; <a href="#" class="button-orange button-create"><span>Create</span></a></p>'),
        $(e.selectors.content + " .choose").html(c),
        fairies.API.isGameClosed() &&
          !fairies.API.canByPass() &&
          ($(e.selectors.content + " .choose")
            .find(".button-create, .button-game")
            .addClass("button-disabled"),
          $(e.selectors.content + " .choose").append(
            '<p class="center error-list">Pixie Hollow is currently unavailable, please check back soon.</p>',
          )));
    }
  }
  function G(a) {
    ...
    ($("fairies fairy", a).length
      ? ((b += '<div class="one-fairy">'),
        (b += "<h2>Welcome Back</h2>"),
        (b +=
          '<h5 class="center">' + $("fairies fairy name", a).text() + "</h5>"),
        (b +=
          '<div class="fairy-large"><img src="' +
          e.calls.renderer +
          $("fairies fairy", a).attr("fairy_id") +
          '/full" /></div>'),
        (b +=
          '<p class="center buttons"><a href="#" class="button-blue button-pixie-page"><span>Pixie Page</span></a> &nbsp; <a href="#" class="button-orange button-game"><span>Play</span></a></p>'),
        (b += "</div>"),
        fairies.API.chooseFairy(
          $("fairies fairy", a).attr("fairy_id"),
          function () {
            h = $("fairies fairy", a).attr("fairy_id");
          },
        ),
        $(e.selectors.content + " .choose").html(b),
        $(e.selectors.playFairy).css("display", "inline-block"),
        $(e.selectors.pixiePage).css("display", "inline-block"))
      : ((b += '<div class="no-fairy">'),
        (b += "<h2>Welcome Back</h2>"),
        (b += '<h5 class="center">Create a Fairy and fly now!</h5>'),
        (b +=
          '<p class="center buttons"><a href="#" class="button-orange button-create"><span>Create a Fairy</span></a>'),
        (b += "</div>"),
        $(e.selectors.content + " .choose").html(b),
        $(e.selectors.createFairy).css("display", "inline-block")),
      $(e.selectors.content + " .choose")
      ...
      fairies.API.isGameClosed() &&
        ...
        ($(e.selectors.content + " .choose")
          .find(".button-create, .button-game")
          .addClass("button-disabled"),
        $(e.selectors.content + " .choose > div").append(
        ...
        fairies.API.isPaid()
          ? ($(e.selectors.promo + " .top-extras").html(""),
            $(e.selectors.promo + " .bottom-extras").html(
              '<img src="' + e.calls.pixiePostingText + '" />',
            ))
          : ($(e.selectors.promo + " .top-extras").html(""),
            $(e.selectors.promo + " .bottom-extras").html("")))
  ...
  var b = new Date(2011, 10, 10),
    ...
    d =
      b.getTime() <=
      new Date(c.getFullYear(), c.getMonth(), c.getDate()).getTime(),
    e = {
      selectors: {
      ...
      calls: {
        ...
        congratsPage:
          PATH.root + "/pixie-hollow/membership/congratulation.html",
        ...
        membershipIcon:
          PATH.CDN +
          "/pixie-hollow/img/content/mini-manager/icon.membership.png",
        pixiePostingText:
          PATH.CDN +
          "/pixie-hollow/img/content/mini-manager/pixie-posting-text.png",
      },
      promos: {
        chooseAFairy:
          PATH.CDN +
          "/pixie-hollow/img/publishing/mini-manager/promo.choose-fairy.jpg",
        login:
          PATH.CDN +
          "/pixie-hollow/img/publishing/mini-manager/promo.login.jpg",
      },
    },
    f = this,
    g = !1,
  ...
  (e.calls.defaultABurl,
    new Array(
      ...
      "pixie-central",
      "pixie-central.html",
      "pixie-hollow-world.html",
      "pixie-hollow-world",
    ),
    new Array("account-manager", "registration", "purchase", "agree", "terms"));
  var n = !1;
  ((this.showLoyaltyInterstitial = function () {
    return fairies.API.isLoggedIn()
      ? (fairies.API.listen("fairies", function () {
          var a = $(
              "fairies fairy:first member_days",
              fairies.API.XMLs.fairies,
            ).text(),
            b = $("member_days", fairies.API.XMLs.whoAmI).text(),
            c = b >= 0 && 90 > b && 0 > a,
            d = Math.floor(b / 90) > Math.floor(a / 90);
          (!c && !d) ||
            $.cookie("loyaltyInterstitial") ||
            $.flashProxy.get(e.calls.loyaltyXML, function (a) {
              a = $.parseXML(a);
              ...
              if ($("level:eq(" + c + ")", a).length) {
                ...
                ($("#loyaltyOverlay").remove(),
                  ...
                  swfobject.embedSWF(
                    ...
                    "486",
                    "10.0.0",
                    "http://a.dolimg.com/swf/dcom/expressInstall.swf",
                    d,
                    f,
                  ));
              }
    ...
    (this.showPickAFairy = function () {
      ((j = "choose"),
        H(),
        $(e.selectors.content + " .login").hide(),
        $(e.selectors.content + " .choose").show(),
        fairies.API.listen("fairies", F),
        fairies.API.loadFairies());
    }),
    (this.showLogin = function (a) {
      ((j = "login"),
        ...
        $.cookie("ph-username") &&
          $(e.selectors.content)
            .find("input[name=username]")
            .val($.cookie("ph-username")),
        $(e.selectors.content + " .choose").hide(),
        $(e.selectors.content + " .login").show());
    }),
...
var Popup = function (a) {
  function d() {
    (typeof a == "object" && (c = $.extend(c, a)),
      $(".popup").filter(":not(.popup-manager)").length &&
        fairies.preload(
          [
            PATH.CDN + "/pixie-hollow/img/templates/popup/frame-top.png",
            PATH.CDN + "/pixie-hollow/img/templates/popup/frame-bottom.png",
          ],
          5e3,
        ));
  }
  ...
  ((this.toggle = function (a, d, e) {
    ...
    if (a.is(":visible") && d != "show")
      a.parent().fadeOut(function () {
        (a.hide(),
          a.unwrap(),
          a.find(c.selectors.close).unbind("click"),
          $(window).unbind("resize"),
          e());
      });
    else if (!a.is(":visible") && d != "hide") {
      ($("body").append(a),
        a.wrap('<div id="' + c.elements.popupFade + '" />'));
      var f = function () {
        ($("#" + c.elements.popupFade).width($("body").width()),
          $("#" + c.elements.popupFade).height($(document).height()));
      ...
      (f(),
        ...
        a.fadeIn(function () {
          (a
            ...
            a.find(c.selectors.close).click(function (c) {
